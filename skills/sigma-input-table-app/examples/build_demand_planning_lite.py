...
elements = [
    ...
    },
    {
        ...
        "columns": [
            {"id": "chM", "formula": "DateTrunc(\"day\", [monthdt])", "name": "Month", "format": {"kind": "datetime", "formatString": "%b %Y"}},
            {"id": "chFcstStat", "formula": "Sum([statfcst])", "name": "Statistical forecast", "format": NUM2S},
            {"id": "chSales", "formula": "Sum([actsales])", "name": "Actual sales", "format": NUM2S},
            {"id": "chAdj", "formula": "Sum([adjplan])", "name": "Adjusted demand plan", "format": NUM2S},
        ],
    ...
    },
    {
        ...
        "kind": "kpi-chart",
        "source": {"elementId": "book", "kind": "table"},
        "columns": [{"id": "kv", "formula": "Sum([statfcst])", "format": NUM2S}],
        "value": {"columnId": "kv"},
    ...
    },
    {
        ...
        "kind": "kpi-chart",
        "source": {"elementId": "book", "kind": "table"},
        "columns": [{"id": "kv", "formula": "Sum([adjplan])", "format": NUM2S}],
        "value": {"columnId": "kv"},
    ...
    },
    {
        ...
        "kind": "kpi-chart",
        "source": {"elementId": "book", "kind": "table"},
        "columns": [{"id": "kv", "formula": "(Sum([adjplan]) - Sum([statfcst])) / NullIf(Sum([statfcst]), 0)", "format": PCT1}],
        "value": {"columnId": "kv"},
    ...
    },
    {
        ...
        "kind": "kpi-chart",
        "source": {"elementId": "book", "kind": "table"},
        "columns": [{"id": "kv", "formula": "1 - Sum(Abs([actsales] - [statfcst])) / NullIf(Sum([actsales]), 0)", "format": PCT1}],
        "value": {"columnId": "kv"},
