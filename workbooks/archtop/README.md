...
2. **Budget & Forecast App** — editable market assumptions feeding projected
   ARR, EBITDA, margin and free cash flow; Base Case, Board Plan and Downside
   scenarios; plus submit/approve writeback history.
3. **Growth Planner** — editable market-level campaign assumptions connected to
   ...
   incremental ARR and CAC. Includes scenario switching and campaign
   owner/status workflow.
4. **FCC Reporting** — export-ready BDC summary plus an editable exception
   review queue.

Selecting a market in the reconciliation, budget or growth visuals opens a
cross-functional market-detail drawer. Selecting a county in the FCC summary
opens speed-tier evidence and exception detail.
