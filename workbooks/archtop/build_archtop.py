...
def build_spec() -> dict:
    ...
    add({
        ...
        "columns": [
            ...
            {"id": "plan-subs", "name": "Subscribers",
             ...
             "format": NUM0},
            {"id": "plan-color", "name": "Package Color",
             "formula": f"[{fin}/Plan]"},
        ],
    ...
    add({
        ...
        "conditionalFormats": [
            {"type": "dataBars", "columnIds": ["rc-bill"],
             "scheme": [NAVY, "#EEF4F7"]},
            {"type": "single", "columnIds": ["rc-var"],
             "condition": "formula", "formula": "Abs([Variance]) >= 500",
             "style": {"backgroundColor": "#FCE8E6", "color": BAD,
                       "bold": True}},
            {"type": "single", "columnIds": ["rc-dupes"],
             "condition": ">", "value": 30,
             "style": {"backgroundColor": "#FFF1D6", "color": WARN,
                       "bold": True}},
            {"type": "single", "columnIds": ["rc-quality"],
             "condition": "<", "value": 0.90,
             "style": {"backgroundColor": "#FCE8E6", "color": BAD,
                       "bold": True}},
            {"type": "single", "columnIds": ["rc-quality"],
             "condition": "Between", "low": 0.90, "high": 0.95,
             "style": {"backgroundColor": "#FFF1D6", "color": WARN}},
            {"type": "single", "columnIds": ["rc-quality"],
    ...
    add({
        ...
        "conditionalFormats": [
            {"type": "single",
             "columnIds": [
                 "ib-adds-entry", "ib-arpu-entry", "ib-opex-entry",
                 "ib-capex-entry", "ib-comment"
             ],
             "condition": "formula", "formula": "True",
             "style": {"backgroundColor": "#FFF0ED"}},
            {"type": "dataBars", "columnIds": ["ib-ebitda-delta"],
             "scheme": [CORAL, "#F7FAFC"]},
            {"type": "single", "columnIds": ["ib-ebitda-margin"],
             "condition": "<", "value": 0.25,
             "style": {"backgroundColor": "#FCE8E6", "color": BAD,
                       "bold": True}},
            {"type": "single", "columnIds": ["ib-ebitda-margin"],
             "condition": "Between", "low": 0.25, "high": 0.35,
             "style": {"backgroundColor": "#FFF1D6", "color": WARN}},
            {"type": "single", "columnIds": ["ib-ebitda-margin"],
             "condition": ">", "value": 0.35,
             "style": {"backgroundColor": "#E5F5EF", "color": GOOD}},
            {"type": "single", "columnIds": ["ib-free-cash"],
             "condition": "<", "value": 0,
             "style": {"backgroundColor": "#FCE8E6", "color": BAD,
                       "bold": True}},
            {"type": "single", "columnIds": ["ib-free-cash"],
    ...
    add({
        ...
        "sort": [
            {"columnId": "log-at", "direction": "descending", "nulls": "last"},
        ],
        "conditionalFormats": [
            {"type": "single", "columnIds": ["log-status"],
             "condition": "=", "value": "Submitted",
             "style": {"backgroundColor": "#FFF1D6", "color": WARN,
                       "bold": True}},
            {"type": "single", "columnIds": ["log-status"],
    ...
    add({
        ...
        "columns": [
            ...
            {"id": "bc-color", "name": "Cash Flow Color",
             "formula": f"Sum([{budget}/Free Cash Flow])", "format": MONEY},
        ],
        ...
        "color": {
            "by": "scale",
            "column": "bc-color",
            "scheme": [BAD, "#F7FAFC", GOOD],
            "domain": {"min": -1000000, "mid": 0, "max": 1500000},
        },
        "legend": {"visibility": "hidden"},
        "style": panel(),
    })
    ...
    add({
        ...
        "conditionalFormats": [
            ...
            {"type": "dataBars", "columnIds": ["it-project-adds"],
             "scheme": [CORAL, "#F7FAFC"]},
            {"type": "single", "columnIds": ["it-pen"],
             "condition": "<", "value": 0.20,
             "style": {"backgroundColor": "#FCE8E6", "color": BAD,
                       "bold": True}},
            {"type": "single", "columnIds": ["it-pen"],
             "condition": "Between", "low": 0.20, "high": 0.35,
             "style": {"backgroundColor": "#FFF1D6", "color": WARN}},
            {"type": "single", "columnIds": ["it-pen"],
             "condition": ">", "value": 0.35,
             "style": {"backgroundColor": "#E5F5EF", "color": GOOD}},
    ...
    add({
        ...
        "columns": [
            ...
            {"id": "grow-color", "name": "Growth Color",
             "formula": f"Sum([{growth}/Projected Net Adds])", "format": NUM0},
        ],
        "xAxis": {
    ...
    add({
        ...
        "conditionalFormats": [
            {"type": "dataBars", "columnIds": ["fs-served"],
             "scheme": [NAVY, "#F7FAFC"]},
            {"type": "single", "columnIds": ["fs-address"],
             "condition": ">", "value": 25,
             "style": {"backgroundColor": "#FCE8E6", "color": BAD,
                       "bold": True}},
            {"type": "single", "columnIds": ["fs-address"],
             "condition": "Between", "low": 10, "high": 25,
             "style": {"backgroundColor": "#FFF1D6", "color": WARN}},
            {"type": "single", "columnIds": ["fs-address"],
             "condition": "<", "value": 10,
             "style": {"backgroundColor": "#E5F5EF", "color": GOOD}},
    ...
    add({
        ...
        "conditionalFormats": [
            {"type": "single",
             "columnIds": ["fr-owner", "fr-resolution", "fr-certify"],
             "condition": "formula", "formula": "True",
             "style": {"backgroundColor": "#FFF0ED"}},
            {"type": "dataBars", "columnIds": ["fr-address"],
             "scheme": [CORAL, "#F7FAFC"]},
            {"type": "single", "columnIds": ["fr-status-source"],
            ...
            {"type": "single", "columnIds": ["fr-status-source"],
             ...
             "style": {"backgroundColor": "#E5F5EF", "color": GOOD}},
            {"type": "single", "columnIds": ["fr-certify"],
            ...
            {"type": "single", "columnIds": ["fr-certify"],
             ...
             "style": {"backgroundColor": "#FFF1D6", "color": WARN}},
            {"type": "single", "columnIds": ["fr-certify"],
             "condition": "=", "value": "Excluded",
             "style": {"backgroundColor": "#EEF1F3", "color": TEXT}},
        ],
        "tableComponents": {"summaryBar": "hidden"},
        "tableStyle": {
            "preset": "presentation",
